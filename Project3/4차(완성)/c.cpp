...
vector <vector<bool>> All(total_r, vector <bool> (v_size));
...
void* thread_function_back(void* data) {
	...
	long long back_front = ((prime_back[0]*v_size+prime_back[1])+(v_size*total_r/2)-((v_size*total_r/2)%(prime_back[0]*v_size+prime_back[1])))/v_size;
	long long back_back = ((prime_back[0]*v_size+prime_back[1])+(v_size*total_r/2)-((v_size*total_r/2)%(prime_back[0]*v_size+prime_back[1])))%v_size;
	while(back_front<total_r) {
